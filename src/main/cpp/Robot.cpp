...
if((m_stick->GetRawAxis(4)+1 > 0) && (m_stick2->GetRawAxis(4)+1)/2 == 0 && (m_stick2->GetRawAxis(3)+1)/2 == 0){
...
else if((m_stick->GetRawAxis(3)+1) > 0 && (m_stick2->GetRawAxis(4)+1)/2 == 0 && (m_stick2->GetRawAxis(3)+1)/2 == 0){
